...
HELPER_APP = HELPERS_DIR / "DENİZ Calendar Helper.app"
...
def _calendar_permission_message() -> str:
    if IS_WIN:
        return (
            "Takvime erisilemedi. DENİZ kendi yerel takvimini kullanir; "
    ...
    return (
        ...
        "'DENİZ Calendar Helper' uygulamasini ara ve izin ver."
    )
