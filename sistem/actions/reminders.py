...
Windows → actions/win_organizer.py (Outlook Gorevleri veya DENİZ yerel deposu)
...
def _permission_message() -> str:
    if IS_WIN:
        return (
            "Animsaticilara erisilemedi. DENİZ kendi yerel listesini kullanir; "
    ...
    return (
        ...
        "'DENİZ Calendar Helper' uygulamasina izin ver."
    )
