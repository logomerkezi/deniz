...
HELPER_APP = HELPERS_DIR / "DENİZ Screen Helper.app"
...
def _screen_permission_message() -> str:
    ...
    return (
        ...
        "DENİZ'i calistiran uygulamaya izin ver. Genelde Visual Studio Code, Python "
...
def _vision_prompt(query: str, owner_name: str, window_title: str) -> str:
    ...
    return (
        f"Sen {PLATFORM_NAME} uzerinde DENİZ icin ekran analizi yapan bir goruntu yorumlayicisisin.\n"
